...
<template>
    <div class="sticky bottom-0 right-0 rounded-md shadow-sm items-center w-full p-4 border-t border-gray-200 sm:flex sm:justify-between dark:border-gray-700">
        <nav>
