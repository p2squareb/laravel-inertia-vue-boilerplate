        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    <!-- ************* mobile three line menu toggle Start ************* -->
                    ...
                    <!-- ************* mobile three line menu toggle End ************* -->
                    <Link href="/" class="flex ml-2 md:mr-24"><ApplicationLogo /></Link>
                </div>



                <!-- ************* Top Right icon menus Start ************* -->
                <div class="flex items-center">

                    <!-- Theme toggle -->
                    <button type="button" @click="toggleTheme" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-sm p-2">
                        <svg v-if="currentTheme === 'dark'" class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M10 15a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm0-11a1 1 0 0 0 1-1V1a1 1 0 0 0-2 0v2a1 1 0 0 0 1 1Zm0 12a1 1 0 0 0-1 1v2a1 1 0 1 0 2 0v-2a1 1 0 0 0-1-1ZM4.343 5.757a1 1 0 0 0 1.414-1.414L4.343 2.929a1 1 0 0 0-1.414 1.414l1.414 1.414Zm11.314 8.486a1 1 0 0 0-1.414 1.414l1.414 1.414a1 1 0 0 0 1.414-1.414l-1.414-1.414ZM4 10a1 1 0 0 0-1-1H1a1 1 0 0 0 0 2h2a1 1 0 0 0 1-1Zm15-1h-2a1 1 0 1 0 0 2h2a1 1 0 0 0 0-2ZM4.343 14.243l-1.414 1.414a1 1 0 1 0 1.414 1.414l1.414-1.414a1 1 0 0 0-1.414-1.414ZM14.95 6.05a1 1 0 0 0 .707-.293l1.414-1.414a1 1 0 1 0-1.414-1.414l-1.414 1.414a1 1 0 0 0 .707 1.707Z"/>
                        </svg>
                        <svg v-else class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <Dropdown :align="'right'" :width="'40'" class="mt-1">
                        ...
                        <template #content>
                            <DropdownLink :href="route('profile.edit')">
                                ...
                                <span class="dark:text-gray-100">1:1 문의 미답변</span>
                            </DropdownLink>
                            <DropdownLink :href="route('mypage.overview')">
                                ...
                                <span class="dark:text-gray-100">신고 내역</span>
                            </DropdownLink>
                        </template>
                    </Dropdown>
