...
<template>
    <div class="p-3 bg-white block sm:flex items-center justify-between border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div class="w-full mb-1">
            ...
            <div class="col-span-6 sm:col-full text-right">
                <button type="button" wire:click.prevent="updateBasic" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-md text-sm px-5 py-[7px] text-center dark:bg-blue-600 dark:hover:bg-blue-700">설정 완료</button>
            </div>
        </div>
    </div>
</template>
