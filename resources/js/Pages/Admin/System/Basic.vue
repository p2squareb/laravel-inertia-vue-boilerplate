                ...
                <div class="p-3 sm:p-6 my-3 bg-white border border-gray-200 rounded-md shadow-sm col-span-full dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-2">
                            <InputLabel for="site_name" value="사이트명" class="block mb-2" />
                            <TextInput type="text" id="site_name" v-model="form.site_name" class="block w-full p-[7px]" required placeholder="사이트명을 입력해주세요." />
                            <InputError :message="form.errors.site_name" />
                        </div>
                        <div class="col-span-6 sm:col-span-2">
                            <InputLabel for="domain_name" value="도메인" class="block mb-2" />
                            <TextInput type="text" id="domain_name" v-model="form.domain_name" class="block w-full p-[7px]" required placeholder="도메인을 입력해주세요." />
                            <InputError :message="form.errors.domain_name" />
                        </div>
                        <div class="col-span-6 sm:col-span-2">
                            <InputLabel for="sq_email" value="대표 이메일" class="block mb-2" />
                            <TextInput type="email" id="sq_email" v-model="form.sq_email" class="block w-full p-[7px]" required placeholder="대표 이메일을 입력해주세요." />
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            <label for="use_dormant" class="flex mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                <span class="mr-3">휴면회원 사용여부 설정</span>
                                <Tooltip placement="bottom">
                                    <template #trigger>
                                        <button type="button" class="align-top mt-[2px]">
                            ...
                            <div
                                 class="absolute z-100 inline-block text-xs font-light text-gray-700 transition-opacity duration-300 bg-white border border-gray-200 rounded-md shadow-sm w-80 sm:w-[520px] dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 opacity-0 invisible"
