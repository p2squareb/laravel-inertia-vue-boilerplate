            ...
            <div class="w-full max-w-md p-6 sm:p-8 bg-white rounded-md shadow dark:bg-gray-800">
                ...
                <form class="mt-5 space-y-5" @submit.prevent="submit">
                    ...
                    <div>
                        ...
                        <TextInput type="password" id="password" v-model="form.password" class="mb-2 block w-full p-[7px]" required placeholder="대문자+숫자 포함 (8~16자)" />
                        <TextInput type="password" id="password_confirmation" v-model="form.password_confirmation" class="block w-full p-[7px]" required placeholder="대문자+숫자 포함 (8~16자)" />
                        ...
                        <div class="flex items-start mt-2">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="privacy" class="font-medium text-gray-900 dark:text-white">
                                    <Link :href="route('site-policy', {id: 'policy'})" class="text-blue-700 hover:underline dark:text-blue-500">개인정보 수집/이용</Link>에 동의합니다.{{ form.errors.terms }}
                                </label>
                            </div>
                        </div>
