        ...
        <div class="w-full min-w-[330px] sm:w-[400px] mb-7 p-6 bg-white rounded-md shadow dark:bg-gray-800">
            <form @submit.prevent="updatePassword">
                <div class="-mt-2">
                    ...
                    <TextInput type="password" id="current_password" ref="currentPasswordInput" v-model="form.current_password" class="mb-2 block w-full p-[7px]" required placeholder="대문자+숫자 포함 (8~16자)" />
                ...
                <Button class="w-full mt-3 px-5 py-[7px] font-medium text-center" :color="'blue'" :disabled="form.processing">비밀번호 변경하기</Button>
                <Transition
